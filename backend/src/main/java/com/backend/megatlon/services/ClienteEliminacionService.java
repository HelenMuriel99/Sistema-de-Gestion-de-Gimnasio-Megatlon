...
public class ClienteEliminacionService {
    ...
    @Transactional
    public EliminacionUsuarioResponse desactivarClientePorCi(String ciCliente, String ciEjecutor) {

        // 1. Obtener el usuario autenticado que realiza la acción (Propietario o Recepcionista)
        ...
        // 4. Validar pertenencia a la sucursal SOLO SI el ejecutor no es PROPIETARIO
