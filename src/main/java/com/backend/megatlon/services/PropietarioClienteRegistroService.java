...
public class PropietarioClienteRegistroService {
    ...
    public ClienteResponse registrarCliente(RegistrarClienteRequest request, Long sucursalId) {
        ...
        // 5. Crear e insertar la entidad Usuario sin contraseña inicial
        Usuario cliente = Usuario.builder()
                .ci(request.getCi())
                .primerNombre(request.getPrimerNombre())
                .segundoNombre(request.getSegundoNombre())
        ...
        // Generar contraseña plana utilizando CredentialGenerator
        String passwordPlana = credentialGenerator.generarPasswordPlana(cliente);
